...
def DRL_prediction(df,
    ...
    ## trading env
    trade_data = data_split(df, start=20210110000000, end=20210215070500)
...
def run_ensemble_strategy(df, unique_trade_date, rebalance_window, validation_window) -> None:
    ...
    insample_turbulence = df[(df.datadate < 20200601000000)]
    ...
    for i in range(rebalance_window + validation_window, len(unique_trade_date), rebalance_window):
        ...
        # train = data_split(df, start=20090000000000, end=unique_trade_date[i - rebalance_window - validation_window])
        train = data_split(df, start=20090000000000, end=20201001000000)

        # i - rebalance_window - validation_window index of train end - 01-10-2020
        # i - rebalance_window index of validation end - 10-01-2021
        #
        ...
        validation = data_split(df, start=20201001000000, end=20210110000000)
